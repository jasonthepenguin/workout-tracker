        ...
        <>
            ...
            <ul className="rules-list">
                ...
                <div className="rule-item">
                    ...
                    <p>Every rep is a puse rep following a <abbr title="2 seconds down - 2 seconds pause - 2 seconds up "> 2 - 2 - 2 tempo </abbr> </p>
            ...
            <small>* The first and second set should be at 70% and 85% of your working weight used for the last two sets </small>
            ...
            <p>Complete all of the worksout below and track your progress along the way ✅</p>
        </>
    )
}